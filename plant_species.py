...
STRONG_PLANT_SPECIES = {
    ...
    "seed_viability_duration_cycles": 90, # 씨앗 발아 가능 기간 (일)
    "min_water_for_germination_soil": 15.0, # 씨앗 발아 최소 토양 수분량 (mm)
    "min_temperature_for_germination": 5.0, # 씨앗 발아 최소 온도 (℃)
    ...
    "default_target_size_for_adult": 0.3,    # 성체로 간주되는 최소 크기 (0.0 ~ 1.0)
    "maturity_age_cycles": int(0.5 * 360),     # 성숙하여 번식 가능한 최소 나이 (0.5년)
